...
from homeassistant.components.openrgb.config_flow import CannotConnect, InvalidAuth
...
async def test_form(hass):
    ...
    with patch(
        "homeassistant.components.openrgb.config_flow.PlaceholderHub.authenticate",
        return_value=True,
    ), patch(
